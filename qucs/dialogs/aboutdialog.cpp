...
AboutDialog::AboutDialog(QWidget* parent)
    : QDialog(parent)
{
    qucs_sDevs = { { "Vadim Kuznetsov - " + tr("project maintainer, simulator interface and GUI design"),
    ...
    currAuths = { { "Guilherme Brondani Torri - " + tr("GUI programmer, Verilog-A dynamic loader"),
    ...
    prevDevs = { { "Michael Margraf - " + tr("founder of the project, GUI programmer"),
    ...
    supportText = tr("Home Page") + " : <a href='https://ra3xdh.github.io/'>https://ra3xdh.github.io/</a><br/>" + tr("Documentation start page") + " : <a href='https://qucs-s-help.readthedocs.io/'>https://qucs-s-help.readthedocs.io/</a><br/>" + tr("Bugtracker page") + " : <a href='https://github.com/ra3xdh/qucs_s/issues'>https://github.com/ra3xdh/qucs_s/issues</a><br/>" + tr("Forum") + " : <a href='https://github.com/ra3xdh/qucs_s/discussions'>https://github.com/ra3xdh/qucs_s/discussions</a><br/>";
