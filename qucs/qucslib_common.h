...
inline int makeModelString(QString libPath, QString compname, QString compstring, QString& modelstring, QString default_sym)
{
    ...
    if (symbolSection.isEmpty()) { // component definition contains no symbol, use library default
    ...
    modelstring = "<Lib " + Prefix + " 1 0 0 " + QString::number(Text_x) + " " + QString::number(Text_y) + " 0 0 \"" + libPath + "\" 0 \"" + compname + "\" 0>";
