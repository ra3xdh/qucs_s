...
QString andor4x3::vhdlCode(int)
{
    ...
    s = "\n  " + Name + ":process (" + a11 + ", " + a12 + ", " + a13 + ", " + a21 + ", " + a22 + ", " + a23 + ", " + a31 + ", " + a32 + ", " + a33 + ", " + a41 + ", " + a42 + ", " + a43 + ")\n" + "  begin\n    " + y + " <= " + "(" + a11 + " and " + a12 + " and " + a13 + ") or " + "(" + a21 + " and " + a22 + " and " + a23 + ") or\n" + "                 (" + a31 + " and " + a32 + " and " + a33 + ") or " + "(" + a41 + " and " + a42 + " and " + a43 + ")" + td + "  end process;\n";
    return s;
}
