...
{
    Rects.append(new qucs::Rect(-30, -90, 60, 190, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::SquareCap, Qt::MiterJoin)));
...
QString dmux3to8::vhdlCode(int)
{
    ...
    s = "\n  " + Name + ":process (" + En + ", " + A + ", " + B + ", " + C + ")\n" + "  begin\n" + "    " + Y0 + " <= " + "(not " + En + ") and (not " + C + ") and (not " + B + ") and (not " + A + ")" + td + "    " + Y1 + " <= " + "(not " + En + ") and (not " + C + ") and (not " + B + ") and " + A + td + "    " + Y2 + " <= " + "(not " + En + ") and (not " + C + ") and " + B + " and (not " + A + ")" + td + "    " + Y3 + " <= " + "(not " + En + ") and (not " + C + ") and " + B + " and " + A + td + "    " + Y4 + " <= " + "(not " + En + ") and " + C + " and (not " + B + ") and (not " + A + ")" + td + "    " + Y5 + " <= " + "(not " + En + ") and " + C + " and (not " + B + ") and " + A + td + "    " + Y6 + " <= " + "(not " + En + ") and " + C + " and " + B + " and (not " + A + ")" + td + "    " + Y7 + " <= " + "(not " + En + ") and " + C + " and " + B + " and " + A + td + "  end process;\n";
    return s;
}
