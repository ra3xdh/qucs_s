...
HBT_X::HBT_X()
{
  ...
  // B
  Lines.append(new qucs::Line(-23,-30,-23,-24,QPen(Qt::darkBlue,1)));
  Lines.append(new qucs::Line(-24,-30,-20,-30,QPen(Qt::darkBlue,1)));
  Lines.append(new qucs::Line(-23,-27,-20,-27,QPen(Qt::darkBlue,1)));
  Lines.append(new qucs::Line(-24,-24,-20,-24,QPen(Qt::darkBlue,1)));
  Lines.append(new qucs::Line(-20,-30,-20,-27,QPen(Qt::darkBlue,1)));
  Lines.append(new qucs::Line(-20,-27,-20,-24,QPen(Qt::darkBlue,1)));
  // T
  Lines.append(new qucs::Line(-18,-30,-14,-30,QPen(Qt::darkBlue,1)));
  Lines.append(new qucs::Line(-16,-30,-16,-24,QPen(Qt::darkBlue,1)));
