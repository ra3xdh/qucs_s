...
void EKV26MOS::createSymbol()
{
  ...
  Lines.append(new qucs::Line(-30,-30,-26,-30,QPen(Qt::darkBlue,1)));
  Lines.append(new qucs::Line(-30,-27,-26,-27,QPen(Qt::darkBlue,1)));
  Lines.append(new qucs::Line(-30,-24,-26,-24,QPen(Qt::darkBlue,1)));
  // K
  Lines.append(new qucs::Line(-24,-30,-24,-24,QPen(Qt::darkBlue,1)));
  Lines.append(new qucs::Line(-24,-27,-20,-30,QPen(Qt::darkBlue,1)));
  Lines.append(new qucs::Line(-24,-27,-20,-24,QPen(Qt::darkBlue,1)));
  // V
  Lines.append(new qucs::Line(-18,-30,-16,-24,QPen(Qt::darkBlue,1)));
  Lines.append(new qucs::Line(-14,-30,-16,-24,QPen(Qt::darkBlue,1)));
