...
{
    QString s = Name + QString::number(x1) + " " + QString::number(y1) + " " + QString::number(x2 - x1) + " " + QString::number(y2 - y1) + " " + pen.color().name() + " " + QString::number(pen.width()) + " " + QString::number(pen.style()) + " " + brush.color().name() + " " + QString::number(brush.style());
    if (filled)
        s += " 1";
    else
        s += " 0";
...
{
    QString b = filled ? QString(", QBrush (QColor (\"%1\"), %2)").arg(brush.color().name()).arg(toBrushString(brush.style())) : "";
...
{
    QString b = filled ? QString("\"colorfill\" : \"%1\", \"stylefill\" : \"%2\"").arg(brush.color().name()).arg(toBrushString(brush.style())) : "";

    QString s = QStringLiteral("{\"type\" : \"rectangle\", "
                               "\"x\" : %1, \"y\" : %2, \"w\" : %3, \"h\" : %4, "
