...
void Component::paintMicrostripVia(QPainter *painter) {
  ...
  painter->drawLine(QPoint(-groundLineWidth/2, 0), QPoint(groundLineWidth/2, 0));
  ...
  painter->drawText(QRect(OriginText + QPoint(0, 20), QPoint(100, 100)), QString("N=%1").arg(Value["N"]));
}
