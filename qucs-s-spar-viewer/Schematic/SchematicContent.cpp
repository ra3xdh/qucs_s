...
QList<struct WireInfo> SchematicContent::getWires() {
  return Wires;
}

QList<struct NodeInfo> SchematicContent::getNodes() {
  return Nodes;
}
...
double SchematicContent::getZin() {
  return Comps[0].val["Z"].toDouble();
}
