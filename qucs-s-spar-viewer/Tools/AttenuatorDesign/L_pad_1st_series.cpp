...
// Reference: Based on the design equations from attenuatorfunc.cpp L_PAD_1ST_SERIES case
void AttenuatorDesigner::LPadFirstSeriesAttenuator() {
  ...
  Schematic.appendNode(NI);
         ...
         // Shunt resistor (R2)
  Res2.setParams(QString("R%1").arg(++Schematic.NumberComponents[Resistor]), Resistor, 0, 150, 50);
