...
void CascadedLCSections::CreateHighpassSolution(){
  ...
  for (int i = 0; i < N; i++) {
    ...
    if (RS > RL) {
      // Lshunt
      Lshunt.setParams(QString("L%1").arg(++Schematic.NumberComponents[Inductor]), Inductor, 0, x_pos + i * x_spacing, 50);
      Lshunt.val["L"] = num2str(L[i], Inductance);
      Schematic.appendComponent(Lshunt);

      gnd.setParams(QString("GND%1").arg(++Schematic.NumberComponents[GND]), GND, 0, x_pos + i * x_spacing, 100);
      Schematic.appendComponent(gnd);

             // Cseries
      Cseries.setParams(QString("C%1").arg(++Schematic.NumberComponents[Capacitor]), Capacitor, -90, x_pos + i * x_spacing + x_spacing/2, 0);
      Cseries.val["C"] = num2str(C[i], Capacitance);
      Schematic.appendComponent(Cseries);

      node.setParams(QString("N%1").arg(++Schematic.NumberComponents[ConnectionNodes]), x_pos + i * x_spacing, 0);
      ...
      node.setParams(QString("N%1").arg(++Schematic.NumberComponents[ConnectionNodes]), x_pos + (i + 1) * x_spacing, 0);
      Schematic.appendNode(node);

             // Cshunt
      Lshunt.setParams(QString("L%1").arg(++Schematic.NumberComponents[Inductor]), Inductor, 0, x_pos + (i + 1) * x_spacing, 50);
      Lshunt.val["L"] = num2str(L[N-i-1], Inductance);
      Schematic.appendComponent(Lshunt);

      gnd.setParams(QString("GND%1").arg(++Schematic.NumberComponents[GND]), GND, 0, x_pos + (i + 1) * x_spacing, 100);
      Schematic.appendComponent(gnd);
...
void CascadedLCSections::CreateLowpassSolution(){
  ...
  for (int i = 0; i < N; i++) {
    ...
    if (RS > RL) {
      // Cshunt
      Cshunt.setParams(QString("C%1").arg(++Schematic.NumberComponents[Capacitor]), Capacitor, 0, x_pos + i * x_spacing, 50);
      ...
      Schematic.appendComponent(gnd);
             ...
             // Lseries
      Lseries.setParams(QString("L%1").arg(++Schematic.NumberComponents[Inductor]), Inductor, -90, x_pos + i * x_spacing + x_spacing/2, 0);
      ...
      Schematic.appendNode(node);
             ...
             // Cshunt
      Cshunt.setParams(QString("C%1").arg(++Schematic.NumberComponents[Capacitor]), Capacitor, 0, x_pos + (i + 1) * x_spacing, 50);
