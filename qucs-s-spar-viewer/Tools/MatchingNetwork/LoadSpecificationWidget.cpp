...
void LoadSpecificationWidget::setupTwoPortUI()
{
    ...
    m_s11Real->setDecimals(6);
    m_s11Real->setSingleStep(0.001);
    m_s11Separator = new QLabel("+j");
    m_s11Imag = new QDoubleSpinBox();
    m_s11Imag->setRange(-10.0, 10.0);
    m_s11Imag->setDecimals(6);
    m_s11Imag->setSingleStep(0.001);
    ...
    m_s12Real->setDecimals(6);
    m_s12Real->setSingleStep(0.001);
    m_s12Separator = new QLabel("+j");
    m_s12Imag = new QDoubleSpinBox();
    m_s12Imag->setRange(-10.0, 10.0);
    m_s12Imag->setDecimals(6);
    m_s12Imag->setSingleStep(0.001);
    ...
    m_s21Real->setDecimals(6);
    m_s21Real->setSingleStep(0.001);
    m_s21Separator = new QLabel("+j");
    m_s21Imag = new QDoubleSpinBox();
    m_s21Imag->setRange(-10.0, 10.0);
    m_s21Imag->setDecimals(6);
    m_s21Imag->setSingleStep(0.001);
    ...
    m_s22Real->setDecimals(6);
    m_s22Real->setSingleStep(0.001);
    m_s22Separator = new QLabel("+j");
    m_s22Imag = new QDoubleSpinBox();
    m_s22Imag->setRange(-10.0, 10.0);
    m_s22Imag->setDecimals(6);
    m_s22Imag->setSingleStep(0.001);
