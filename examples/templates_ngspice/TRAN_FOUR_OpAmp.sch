...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=TRAN_FOUR_OpAmp.dat>
  <DataDisplay=TRAN_FOUR_OpAmp.dpl>
  <OpenDisplay=0>
  <Script=TRAN_FOUR_OpAmp.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <.DC DC1 1 40 320 0 44 0 0 "26.85" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "no" 0 "150" 0 "no" 0 "none" 0 "CroutLU" 0>
  <.FOURIER FOUR1 1 220 320 0 73 0 0 "TR1" 1 "10" 1 "1kHz" 1 "V(out)" 1>
  <.TR TR1 1 40 400 0 73 0 0 "lin" 1 "0" 1 "5ms" 1 "500" 1 "Trapezoidal" 0 "2" 0 "1 ns" 0 "1e-16" 0 "150" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "26.85" 0 "1e-3" 0 "1e-6" 0 "1" 0 "CroutLU" 0 "no" 0 "yes" 0 "0" 0>
...
<Diagrams>
  ...
  <Rect 510 680 541 322 3 #c0c0c0 1 00 1 0 1000 9000 1 -0.099952 0.2 1.09947 1 -1 0.5 1 315 0 225 1 0 0 "" "" "">
	<"ngspice/magnitude(v(out))" #0000ff 2 3 0 6 0>
  </Rect>
  <Rect 510 1050 541 322 3 #c0c0c0 1 00 1 0 1000 9000 1 -250 50 22.286 1 -1 0.5 1 315 0 225 1 0 0 "" "" "">
	<"ngspice/norm(phase(v(out)))" #ff0000 2 3 0 6 0>
  </Rect>
</Diagrams>
<Paintings>
</Paintings>
