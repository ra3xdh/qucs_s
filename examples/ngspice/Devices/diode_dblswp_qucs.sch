...
<Properties>
  <View=-463,-520,2106,929,0.740952,185,107>
  <Grid=10,10,1>
...
<Components>
  ...
  <DIODE_SPICE D1 1 340 170 20 -18 1 3 "1N4007" 1 "" 0 "" 0 "" 0 "" 0 "2" 1 "D" 1>
  <GND * 1 340 220 0 0 0 0>
  <.DC DC1 1 30 400 0 36 0 0 "26.85" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "no" 0 "150" 0 "no" 0 "none" 0 "CroutLU" 0>
  <.SW SW1 1 200 400 0 61 0 0 "DC1" 1 "lin" 1 "V1" 1 "0" 1 "2" 1 "200" 1>
  <R R1 1 230 120 -16 13 0 0 "0.1" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "european" 0>
  <.SW SW2 1 340 400 0 61 0 0 "SW1" 1 "lin" 1 "R1" 1 "0.01" 1 "0.5" 1 "10" 1>
...
<Diagrams>
  <Rect 577 270 354 294 3 #c0c0c0 1 00 1 -1 0.5 1 1 -1 0.5 1 1 -1 0.5 1 315 0 225 1 0 0 "" "" "">
	<"ngspice/sw1.i(pr1)" #0000ff 0 3 0 0 0>
  </Rect>
  <Rect3D 1014 296 366 327 3 #c0c0c0 1 00 1 -1 0.2 1 1 -1 0.5 1 1 -1 0.5 1 315 0 225 1 0 0 "" "" "">
	<"ngspice/sw1.i(pr1)" #0000ff 0 3 0 0 1>
  </Rect3D>
</Diagrams>
<Paintings>
</Paintings>
