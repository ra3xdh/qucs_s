...
<Properties>
  <View=-437,-933,4015,1578,0.916365,322,686>
  <Grid=10,10,1>
...
<Components>
  ...
  <Vac V1 1 140 190 18 -26 0 1 "2 V" 1 "1 GHz" 0 "0" 0 "0" 0 "0" 0 "0" 0>
  ...
  <.AC AC1 1 80 330 0 36 0 0 "lin" 1 "1 GHz" 1 "2 GHz" 1 "2" 1 "no" 0>
  <.SW SW1 1 80 470 0 61 0 0 "AC1" 1 "lin" 1 "R_load" 1 "2 Ohm" 1 "200 Ohm" 1 "100" 1>
  <Eqn Eqn1 1 570 320 -19 13 0 0 "r_calc=(R_load-50)/(R_load+50)" 1 "r_measure=reflected.v / forward.v" 1 "r_meas=PlotVs(r_measure, R_load)" 1 "yes" 0>
</Components>
<Wires>
...
<Diagrams>
  <Rect 900 247 420 257 3 #c0c0c0 1 00 1 0 20 200 1 -1.07538 0.5 0.752308 1 -1 0.5 1 315 0 225 1 0 0 "" "" "">
	<"r_calc" #0000ff 0 3 0 0 0>
	<"r_meas" #ff0000 1 3 0 0 0>
  </Rect>
</Diagrams>
<Paintings>
