...
* Added *LoadOnly* property for 50-Ohm port source. This allows to disable sinewave source
  and port operates as resistive load #1628
* Fixed schematic version generated by new S-Parameter viewer and RF circutis synthesizer #1631
* Fixed continuation line parsing for Spice Library device #1632
* Fixed file extension when saving symbol files #1638
* Fixed XYCE netlist for schematic without simulation #1639
* Fixed netlist entry for MOSFET device if properties defined as variables #1621

## Localization

* Updated IT translation #1633
