...
protected:
    ...
    static void getCoupledMicrostrip(double, double, double, tSubstrate*, double&, double&, double&, double&);
    static void sythesizeCoupledMicrostrip(double, double, double, tSubstrate*, double&, double&, double&);
};
