...
QucsFilter::QucsFilter()
{
    ...
    if (QucsSettings.DefaultSimulator != spicecompat::simQucsator) {
        QStandardItemModel* model = qobject_cast<QStandardItemModel*>(ComboRealize->model());
...
{
    LabelResult->setText(tr("Result:") + "<font color=\"#FF0000\"><b>  " + tr("Error") + "</b></font>");
...
void QucsFilter::slotCalculate()
{
    ...
    ResultState = 0;
    LabelResult->setText(tr("Result:") + "<font color=\"#008000\"><b>  " + tr("Successful") + "</b></font>");
